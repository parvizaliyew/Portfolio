...
<section class="clients-section">
    ...
    <div class="client-logos-wrapper">
        <div class="client-logo"><img src="{{asset('front/')}}/assets/images/Clients_1.svg" alt="logo" class="w-100"></div>
        <div class="client-logo"><img src="{{asset('front/')}}/assets/images/Clients_2.svg" alt="logo" class="w-100"></div>
        <div class="client-logo"><img src="{{asset('front/')}}/assets/images/Clients_3.svg" alt="logo" class="w-100"></div>
        <div class="client-logo"><img src="{{asset('front/')}}/assets/images/Clients_4.svg" alt="logo" class="w-100"></div>
    </div>
</section>
...
<section class="achievements-section">
    ...
    <div class="achievement-cards-wrapper">
        <div class="media achievement-card">
            <img src="{{asset('front/')}}/assets/images/puzzle.svg" alt="puzzle" class="achievement-card-icon">
            <div class="media-body">
        ...
        <div class="media achievement-card">
            <img src="{{asset('front/')}}/assets/images/team.svg" alt="puzzle" class="achievement-card-icon">
            <div class="media-body">
        ...
        <div class="media achievement-card">
            <img src="{{asset('front/')}}/assets/images/trophy.svg" alt="puzzle" class="achievement-card-icon">
            <div class="media-body">
