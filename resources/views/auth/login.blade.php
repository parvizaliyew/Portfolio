...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('manager/assets/sweetalert/sweetalert2.min.css') }}"></link>
  ...
  <body>
          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <form action="{{ route('login_post') }}" method="POST" id="loginForm">
                  @csrf
    ...
    <script src="{{ asset('manager/assets/sweetalert/sweetalert2.all.min.js') }}"></script>
    <!-- endinject -->
